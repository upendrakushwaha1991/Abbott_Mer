...
import com.cpm.Tcl.getterSetter.BrandMasterGetterSetter;
import com.cpm.Tcl.getterSetter.CategoryMaster;
import com.cpm.Tcl.getterSetter.CategoryMasterGetterSetter;
import com.cpm.Tcl.getterSetter.ChecklistAnswer;
import com.cpm.Tcl.getterSetter.ChecklistAnswerGetterSetter;
import com.cpm.Tcl.getterSetter.ChecklistGetterSetter;
import com.cpm.Tcl.getterSetter.ChecklistMaster;
import com.cpm.Tcl.getterSetter.ChecklistMasterGetterSetter;
import com.cpm.Tcl.getterSetter.CommonChillerDataGetterSetter;
import com.cpm.Tcl.getterSetter.DisplayMaster;
import com.cpm.Tcl.getterSetter.DisplayMasterGetterSetter;
import com.cpm.Tcl.getterSetter.FeedbackMaster;
import com.cpm.Tcl.getterSetter.FeedbackMasterGetterSetter;
import com.cpm.Tcl.getterSetter.FocusProductGetterSetter;
import com.cpm.Tcl.getterSetter.GeotaggingBeans;
import com.cpm.Tcl.getterSetter.GroomingGetterSetter;
import com.cpm.Tcl.getterSetter.HeaderGetterSetter;
import com.cpm.Tcl.getterSetter.JCPGetterSetter;
import com.cpm.Tcl.getterSetter.JarGetterSetter;
import com.cpm.Tcl.getterSetter.JourneyPlan;
import com.cpm.Tcl.getterSetter.MappingCategoryChecklist;
import com.cpm.Tcl.getterSetter.MappingCategoryChecklistGetterSetter;
import com.cpm.Tcl.getterSetter.MappingCitywise;
import com.cpm.Tcl.getterSetter.MappingCitywiseGetterSetter;
import com.cpm.Tcl.getterSetter.MappingFocusSku;
import com.cpm.Tcl.getterSetter.MappingFocusSkuGetterSetter;
import com.cpm.Tcl.getterSetter.MappingInitiativeGetterSetter;
import com.cpm.Tcl.getterSetter.MappingMenu;
import com.cpm.Tcl.getterSetter.MappingMenuChecklist;
import com.cpm.Tcl.getterSetter.MappingMenuChecklistGetterSetter;
import com.cpm.Tcl.getterSetter.MappingMenuGetterSetter;
import com.cpm.Tcl.getterSetter.MappingPaidVisibility;
import com.cpm.Tcl.getterSetter.MappingPaidVisibilityGetterSetter;
import com.cpm.Tcl.getterSetter.MappingPosm;
import com.cpm.Tcl.getterSetter.MappingPosmGetterSetter;
import com.cpm.Tcl.getterSetter.MappingPromotion;
import com.cpm.Tcl.getterSetter.MappingPromotionGetterSetter;
import com.cpm.Tcl.getterSetter.MappingSampling;
import com.cpm.Tcl.getterSetter.MappingSamplingGetterSetter;
import com.cpm.Tcl.getterSetter.MappingShareOfShelf;
import com.cpm.Tcl.getterSetter.MappingShareOfShelfGetterSetter;
import com.cpm.Tcl.getterSetter.MappingTesterStock;
import com.cpm.Tcl.getterSetter.MappingTesterStockGetterSetter;
import com.cpm.Tcl.getterSetter.MappingVisibilityInitiative;
import com.cpm.Tcl.getterSetter.MappingVisicooler;
import com.cpm.Tcl.getterSetter.MappingVisicoolerGetterSetter;
import com.cpm.Tcl.getterSetter.MappingWindChecklistGetterSetter;
import com.cpm.Tcl.getterSetter.MappingWindow;
import com.cpm.Tcl.getterSetter.MappingWindowChecklist;
import com.cpm.Tcl.getterSetter.MappingWindowGetterSetter;
import com.cpm.Tcl.getterSetter.MarketIntelligenceGetterSetter;
import com.cpm.Tcl.getterSetter.MenuMaster;
import com.cpm.Tcl.getterSetter.MenuMasterGetterSetter;
import com.cpm.Tcl.getterSetter.NonCategoryReason;
import com.cpm.Tcl.getterSetter.NonCategoryReasonGetterSetter;
import com.cpm.Tcl.getterSetter.NonExecutionReason;
import com.cpm.Tcl.getterSetter.NonExecutionReasonGetterSetter;
import com.cpm.Tcl.getterSetter.NonWindowReason;
import com.cpm.Tcl.getterSetter.NonWindowReasonGetterSetter;
import com.cpm.Tcl.getterSetter.NonWorkingReason;
import com.cpm.Tcl.getterSetter.NonWorkingReasonGetterSetter;
import com.cpm.Tcl.getterSetter.PerformancePage;
import com.cpm.Tcl.getterSetter.PerformancePageGetterSetter;
import com.cpm.Tcl.getterSetter.PosmMaster;
import com.cpm.Tcl.getterSetter.PosmMasterGetterSetter;
import com.cpm.Tcl.getterSetter.SampledGetterSetter;
import com.cpm.Tcl.getterSetter.SamplingChecklist;
import com.cpm.Tcl.getterSetter.SamplingChecklistGetterSetter;
import com.cpm.Tcl.getterSetter.ShareOfShelfGetterSetter;
import com.cpm.Tcl.getterSetter.SkuMaster;
import com.cpm.Tcl.getterSetter.SkuMasterGetterSetter;
...
import com.cpm.Tcl.getterSetter.StoreTypeMasterGetterSetter;
import com.cpm.Tcl.getterSetter.SubCategoryMaster;
import com.cpm.Tcl.getterSetter.SubCategoryMasterGetterSetter;
import com.cpm.Tcl.getterSetter.VisiColoersGetterSetter;
import com.cpm.Tcl.getterSetter.WindowCheckAnswerGetterSetter;
import com.cpm.Tcl.getterSetter.WindowChecklist;
import com.cpm.Tcl.getterSetter.WindowChecklistAnswer;
import com.cpm.Tcl.getterSetter.WindowChecklistGetterSetter;
import com.cpm.Tcl.getterSetter.WindowMaster;
import com.cpm.Tcl.getterSetter.WindowMasterGetterSetter;
import com.cpm.Tcl.getterSetter.WindowNonReasonGetterSetter;
...
public class TclDatabase extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "Tcl_DB7";
    public static final int DATABASE_VERSION = 2;
    private SQLiteDatabase db;
    Context context;

    public TclDatabase(Context context) {
    ...
    public long updateStoreStatusOnLeave(String storeid, String visitdate, String status) {
        ...
        try {
            ContentValues values = new ContentValues();
            values.put("Upload_Status", status);
            id = db.update(CommonString.TABLE_Journey_Plan, values, "STORE_ID" + "='" + storeid + "' AND "
                    + CommonString.KEY_VISIT_DATE + "='" + visitdate
                    + "'", null);
            return id;
        } catch (Exception e) {
    ...
    public boolean insertMappingMenuData(MappingMenuGetterSetter mappingMenuGetterSetter) {
        ...
        try {
            ...
            for (int i = 0; i < data.size(); i++) {
                values.put("user_Type", data.get(i).getUserType());
                values.put("Menu_Id", data.get(i).getMenuId());
    ...
    public ArrayList<MenuMaster> getMenuData(int Store_Type_Id, int store_category_id) {
        ...
        try {
           ...
           // dbcursor = db.rawQuery("SELECT M.Menu_Id, M.Menu_Name, M.Normal_Icon, M.Tick_Icon, M.Grey_Icon, M.Menu_Path FROM Menu_Master M INNER JOIN Mapping_Menu MM ON M.Menu_Id = MM.Menu_Id WHERE MM.Store_Type_Id=" + Store_Type_Id + " AND MM.Store_Category_Id=" + store_category_id + " ORDER BY M.Menu_Sequence", null);
            dbcursor = db.rawQuery("SELECT M.Menu_Id, M.Menu_Name, M.Normal_Icon, M.Tick_Icon, M.Grey_Icon, M.Menu_Path FROM Menu_Master M INNER JOIN Mapping_Menu MM ON M.Menu_Id = MM.Menu_Id ORDER BY M.Menu_Sequence", null);
    ...
    public void InsertOpeningStocklistData(JourneyPlan jcp,
                                           HashMap<StockNewGetterSetter, List<StockNewGetterSetter>> data, List<StockNewGetterSetter> save_listDataHeader, String expiryDate) {
        ContentValues values = new ContentValues();
        ContentValues values1 = new ContentValues();
        ...
        try {
            ...
            for (int i = 0; i < save_listDataHeader.size(); i++) {
                ...
                for (int j = 0; j < data.get(save_listDataHeader.get(i)).size(); j++) {
                    ...
                    values1.put("EXPIRED_STOCK", data.get(save_listDataHeader.get(i)).get(j).getExpiry_stock());
                    values1.put("EXPIRED_DATE", expiryDate);
    ...
    public void UpdateOpeningStocklistData(JourneyPlan jcp, HashMap<StockNewGetterSetter, List<StockNewGetterSetter>> data,
                                           List<StockNewGetterSetter> save_listDataHeader, String expiryDate) {
...
*/
            dbcursor = db.rawQuery("Select distinct ca.Category_Id, ca.Category from Mapping_Citywise m " +
                    " inner join Sku_Master sk on m.Sku_Id = sk.Sku_Id " +
                    " inner join Brand_Master br on sk.Brand_Id = br.Brand_Id " +
                    " Inner join Sub_Category_Master sb on br.Sub_category_Id = sb.Sub_Category_Id " +
                    " Inner join Category_Master ca on sb.Category_Id = ca.Category_Id " +
                    " where m.City_Id = '" + jcp.getCityId() + "' and m.Store_Category_Id = '" + jcp.getStoreCategoryId() + "' and m.Store_Type_Id = '" + jcp.getStoreTypeId() + "'", null);
        ...
        try {
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    ...
                    sb.setExpiry_date(dbcursor.getString(dbcursor.getColumnIndexOrThrow("EXPIRED_DATE")));
                    sb.setExpiry_stock(dbcursor.getString(dbcursor.getColumnIndexOrThrow("EXPIRED_STOCK")));
...
*/
            dbcursor = db.rawQuery("Select distinct sk.Sku_Id, sk.Sku,m.Focus from Mapping_Citywise m " +
                    " inner join Sku_Master sk on m.Sku_Id = sk.Sku_Id " +
                    " inner join Brand_Master br on sk.Brand_Id = br.Brand_Id " +
                    " Inner join Sub_Category_Master sb on br.Sub_category_Id = sb.Sub_Category_Id " +
                    " Inner join Category_Master ca on sb.Category_Id = ca.Category_Id " +
                    " where m.City_Id = '" + jcp.getCityId() + "' and m.Store_Category_Id = '" + jcp.getStoreCategoryId() +
                    "' and m.Store_Type_Id = '" + jcp.getStoreTypeId()  + "'and ca.Category_Id = '" + category_id  + "'", null);
...
public long insertmarketintelligenceData(JourneyPlan jcp, String user_name,ArrayList<MarketIntelligenceGetterSetter> list) {
    ...
    public ArrayList<StockNewGetterSetter> getOpeningStockUpload(String category_id) {
        Log.d("Fetching", "Stock upload data--------------->Start<------------");
        ArrayList<StockNewGetterSetter> list = new ArrayList<StockNewGetterSetter>();
        Cursor dbcursor = null;
        try {

            dbcursor = db.rawQuery("SELECT * FROM " + CommonString.TABLE_STOCK_DATA + " WHERE CATEGORY_CD= '" + category_id + "'", null);
    ...
    public ArrayList<StockNewGetterSetter> getstockInsertedStoreDetails(JourneyPlan jcp) {
        ...
        try {
            dbcursor = db.rawQuery("select CATEGORY_CD, CATEGORY, SUM(OPENING_STOCK) AS OPENING_STOCK, SUM(MIDDAY_STOCK) AS MIDDAY_STOCK, SUM(CLOSING_STOCK) AS CLOSING_STOCK ," +
                    "SUM(OPENING_STOCK) +SUM(MIDDAY_STOCK) - SUM(CLOSING_STOCK) AS SALE  from STOCK_DATA  where STORE_ID = '"+jcp.getStoreId()+"' GROUP BY CATEGORY_CD ORDER BY CATEGORY ", null);
           ...
           // dbcursor = db.rawQuery("Select * from "+CommonString.TABLE_STOCK_DATA+" where STORE_ID = "+jcp.getStoreId()+"", null);
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    StockNewGetterSetter sb = new StockNewGetterSetter();
                    sb.setSku(dbcursor.getString(dbcursor.getColumnIndexOrThrow("CATEGORY")));
                    sb.setEd_midFacing(dbcursor.getString(dbcursor.getColumnIndexOrThrow("MIDDAY_STOCK")));
    ...
    public boolean insertMappinCitiwiseData(MappingCitywiseGetterSetter data) {
        db.delete("Mapping_Citywise", null, null);
        List<MappingCitywise> stockData = data.getMappingCitywise();
        ContentValues values = new ContentValues();
        try {
            if (stockData.size() == 0) {
                return false;
            ...
            for (int i = 0; i < stockData.size(); i++) {
                values.put("City_Id", stockData.get(i).getCityId());
                values.put("Focus", stockData.get(i).getFocus());
                values.put("Sku_Id", stockData.get(i).getSkuId());
                values.put("Store_Category_Id", stockData.get(i).getStoreCategoryId());
                values.put("Store_Type_Id", stockData.get(i).getStoreTypeId());

                long id = db.insert("Mapping_Citywise", null, values);
                if (id == -1) {
                    throw new Exception();
                }
            }
    ...
    public boolean insertChecklistAnswerData(ChecklistAnswerGetterSetter storeTypeMaster) {
        ...
        try {
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                values.put("Answer_Id", data.get(i).getAnswerId());
                values.put("Checklist_Id", data.get(i).getChecklistId());
                values.put("QR_Code", data.get(i).getqRCode());
    ...
    public boolean insertMappingWindowData(MappingWindowGetterSetter storeTypeMaster, boolean deleteflag) {
        List<MappingWindow> data;
        if (deleteflag) {
            db.delete("Mapping_Window", null, null);
            data = storeTypeMaster.getMappingWindow();
        } else {
            data = storeTypeMaster.getMappingWindowStorewise();
        }
    ...
    public boolean insertMappingMenuCheckListData(MappingMenuChecklistGetterSetter storeTypeMaster) {
