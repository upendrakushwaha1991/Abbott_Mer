...
public class CommonString {
    ...
    public static String URL = "http://tcl.parinaam.in/webservice/tclservice.svc/";
    public static String URL3 = "http://tcl.parinaam.in/webservice/Imageupload.asmx/";
    public static String URLGORIMAG = "http://tcl.parinaam.in/webservice/Imageupload.asmx/";
    public static final String BACKUP_FILE_PATH = Environment.getExternalStorageDirectory() + "/Tcl_Backup/";
    ...
    //File Path
    public static final String FILE_PATH = Environment.getExternalStorageDirectory() + "/.Tcl_Images/";
    public static final String FILE_PATH1 = Environment.getExternalStorageDirectory() + "/SaleConfirmation_Images/";
    public static final String FOLDER_NAME_WITH_PATH = Environment.getExternalStorageDirectory() + "/.Tcl_Images";
    public static final String FOLDER_NAME_IMAGE = ".Tcl_Images";
    public static final String FILE_PATH_Downloaded = Environment.getExternalStorageDirectory() + "/Tcl_Downloaded_Img/";
