...
import com.cpm.Tcl.geotag.GeoTagStoreList;
import com.cpm.Tcl.geotag.GeoTaggingActivity;
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.yes) {
                    ...
                    dialog.cancel();
                    TclDatabase db = new TclDatabase(context);
                    db.open();
    ...
    private boolean chekDataforCheckout(JourneyPlan journeyPlan) {
        ...
        for (int i = 0; i < menu_list.size(); i++) {
            switch (menu_list.get(i).getMenuId()) {
                ...
                case 13:
                    if (db.getWindowDefaultData(journeyPlan.getStoreTypeId(), journeyPlan.getStoreCategoryId(), journeyPlan.getStateId()).size() > 0) {
