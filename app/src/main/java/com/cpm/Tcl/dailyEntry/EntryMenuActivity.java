...
import com.cpm.Tcl.getterSetter.MenuGetterSetter;
...
public class EntryMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getSerializableExtra(CommonString.KEY_STATUS) != null && getIntent().getStringExtra(CommonString.KEY_IMAGE) != null){
            ...
            shareIntent.putExtra(Intent.EXTRA_STREAM, FileProvider.getUriForFile(EntryMenuActivity.this,"com.cpm.Tcl.fileprovider",photoFile));
    ...
    void declaration() {
        ...
        database = new TclDatabase(context);
        database.open();
    }
